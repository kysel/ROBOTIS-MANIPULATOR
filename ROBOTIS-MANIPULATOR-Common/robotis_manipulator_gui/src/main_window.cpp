    ...
    , qnode(argc,argv)
{
    ...
    ****************************/
    ...
    qRegisterMetaType<manipulator_base_module_msgs::JointPose>("manipulator_base_module_msgs::JointPose");
    QObject::connect(&qnode, SIGNAL(update_curr_joint_pose(manipulator_base_module_msgs::JointPose)), this, SLOT(update_curr_joint_pose_spinbox(manipulator_base_module_msgs::JointPose)));

    qRegisterMetaType<manipulator_base_module_msgs::KinematicsPose>("manipulator_base_module_msgs::KinematicsPose");
    QObject::connect(&qnode, SIGNAL(update_curr_kinematics_pose(manipulator_base_module_msgs::KinematicsPose)), this, SLOT(update_curr_kinematics_pose_spinbox(manipulator_base_module_msgs::KinematicsPose)));
...
{
    manipulator_base_module_msgs::JointPose msg;
...
{
    manipulator_base_module_msgs::KinematicsPose msg;
...
void MainWindow::update_curr_joint_pose_spinbox( manipulator_base_module_msgs::JointPose msg )
{
...
void MainWindow::update_curr_kinematics_pose_spinbox( manipulator_base_module_msgs::KinematicsPose msg )
{
