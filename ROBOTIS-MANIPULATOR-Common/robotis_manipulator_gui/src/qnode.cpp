...
#include <string>
#include <sstream>
#include "../include/robotis_manipulator_gui/qnode.hpp"
...
bool QNode::init() {
    ros::init(init_argc,init_argv,"robotis_manipulator_gui");

	ros::start(); // explicitly needed since our nodehandle is going out of scope.
	ros::NodeHandle n;

    // Add your ros communications here.
    ini_pose_msg_pub = n.advertise<std_msgs::String>("/robotis/base/ini_pose_msg", 0);
    set_mode_msg_pub = n.advertise<std_msgs::String>("/robotis/base/set_mode_msg", 0);

    joint_pose_msg_pub = n.advertise<manipulator_base_module_msgs::JointPose>("/robotis/base/joint_pose_msg", 0);
    kinematics_pose_msg_pub = n.advertise<manipulator_base_module_msgs::KinematicsPose>("/robotis/base/kinematics_pose_msg", 0);

    get_joint_pose_client = n.serviceClient<manipulator_base_module_msgs::GetJointPose>("/robotis/base/get_joint_pose", 0);
    get_kinematics_pose_client = n.serviceClient<manipulator_base_module_msgs::GetKinematicsPose>("/robotis/base/get_kinematics_pose", 0);

    status_msg_sub = n.subscribe("/robotis/status", 10, &QNode::statusMsgCallback, this);
...
void QNode::sendJointPoseMsg( manipulator_base_module_msgs::JointPose msg )
{
...
void QNode::sendKinematicsPoseMsg( manipulator_base_module_msgs::KinematicsPose msg )
{
...
void QNode::getJointPose( std::vector<std::string> joint_name )
{
    ...
    manipulator_base_module_msgs::GetJointPose _get_joint_pose;
    ...
    {
        manipulator_base_module_msgs::JointPose _joint_pose;
...
void QNode::getKinematicsPose ( std::string group_name )
{
    ...
    manipulator_base_module_msgs::GetKinematicsPose _get_kinematics_pose;
    ...
    {
        manipulator_base_module_msgs::KinematicsPose _kinematcis_pose;
