...
public Q_SLOTS:
    ...
    *******************************************/
    ...
    void update_curr_joint_pose_spinbox( manipulator_base_module_msgs::JointPose msg );
    void update_curr_kinematics_pose_spinbox( manipulator_base_module_msgs::KinematicsPose msg );
